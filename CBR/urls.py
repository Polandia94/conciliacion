...
urlpatterns = [
    ...
    path('cbrbice/', views.DetalleErroresBicListView.as_view(),  name='DetalleErroresBicListView'),
    path('cbrbane/', views.DetalleErroresBanListView.as_view(),  name='DetalleErroresBanListView'),
    path('cbrbnce/', views.DetalleErroresBncListView.as_view(),  name='DetalleErroresBncListView'),
